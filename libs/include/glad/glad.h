/*
    ...
    OpenGL loader generated by glad 0.1.36 on Wed Jan 31 19:28:06 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --extensions="GL_ARB_gpu_shader_fp64,GL_ARB_shader_storage_buffer_object,GL_NV_uniform_buffer_std430_layout"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.3&extensions=GL_ARB_gpu_shader_fp64&extensions=GL_ARB_shader_storage_buffer_object&extensions=GL_NV_uniform_buffer_std430_layout
*/
...
#if defined(_WIN32) && !defined(APIENTRY) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__)
